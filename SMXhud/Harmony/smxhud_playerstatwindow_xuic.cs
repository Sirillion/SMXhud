...
*/
        ...
        // From XUiC_QuestTurnInDetailsWindow
        ...
        // From Sirillion - Custom Code to hide skillpointsavailable - WIP - NOT READY!
        if (bindingName == "hasskillpoint")
        {
            ...
            if (XUi.IsGameRunning() && entityPlayer != null)
            {
                string check = (this.skillPointsAvailableFormatter.Format(v, entityPlayer.Progression.SkillPoints));
                if (check == "0")
                    value = "false";
                else
                    value = "true";
